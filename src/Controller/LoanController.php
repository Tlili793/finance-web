...
class LoanController extends AbstractController
{
    ...
    public function dashboard(LoanRepository $loanRepo, HttpClientInterface $client): Response
    {
        ...
        $financialTips = [
            "≡ƒÆ░ Smart Tip: Pay more than the minimum payment to reduce interest charges.",
            "≡ƒôè Financial Health: Keep your debt-to-income ratio below 36%.",
            "≡ƒÄ» Goal Setting: Set up automatic payments to avoid late fees.",
            "≡ƒÆí Emergency Fund: Build savings while paying off debt.",
            "Γ£à Credit Score: Check your credit report annually for errors.",
        ];
